...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('⚡ UᎮDΛTΞS ⚡', url='https://t.me/st_movie_upadate')
            ],
            [
                InlineKeyboardButton('⚡ ST√MasTEr ⚡', url=f"https://t.me/STThamizhan"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ ST√MasTEr ⚡', url='https://t.me/STThamizhan'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/st_movie_upadate')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('UPDaTE', url='https://t.me/st_movie_upadate') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
